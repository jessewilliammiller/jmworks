...
const allShows = [
    ...
    new Show(
        ...
        "Playing guitar in Rachel Ewen's band (our first show!) and doing my improv computer music thing as JM Fodder<br/>Seattle, WA"
    ),
    new Show(
        false,
    ...
    new Show(
        ...
        "My big record release, don't miss this one!<br/>Seattle, WA"
    ),
    new Show(
        false,
    ...
    new Show(
        ...
        "Guitar w/ Peg, also on the bill is Ronan Delisle. very excited for this one:)<br/>Seattle, WA"
    ),
    new Show(
        false,
        "January 27 @ Conor Byrne Pub",
        "Guitar w/ Joe Waine Band<br>Seattle, WA"
    ),
    new Show(
        false,
        "NYE @ Blue Moon Tavern",
        "I’ll be playing guitar with the Joe Waine, also performing is Scott Yoder, Reverse Death (Record Release) and 129,600.<br/>Tickets at the door, $8, 8pm-2am<br/>Seattle, WA"
    ),
    new Show(
        false,
        "December 17th @ House Party (contact for address, details)",
        "I’ll be doing a computer based, electronic set of Reggaeton music as JM Fodder, both original and DJ selections."
    ),
    new Show(
        false,
        "December 11th @ Sunset Tavern",
